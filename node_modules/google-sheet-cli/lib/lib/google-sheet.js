...
class GoogleSheet {
    ...
    async getData(options = {}, spreadsheetId) {
        ...
        const { rowCount = 0, columnCount = 0 } = ((_a = sheet === null || sheet === void 0 ? void 0 : sheet.properties) === null || _a === void 0 ? void 0 : _a.gridProperties) || {};
        const sanitizedOptions = Object.assign(Object.assign({}, parsedOptions), { maxCol: parsedOptions.maxCol || columnCount || 0, maxRow: parsedOptions.maxRow || rowCount || 0 });
        ...
        await this.sheets.spreadsheets.batchUpdate({
            ...
            requestBody: {
                requests: [
                    {
                        deleteSheet: {
                            sheetId: ((_a = sheet.properties) === null || _a === void 0 ? void 0 : _a.sheetId) || -1,
                        },
                    },
                ],
            },
